...
<details open>
<summary><strong>Explore My Project Portfolio</strong></summary>
<br>

| Project | Badges | Description | Tech Stack |
|---|---|---|---|
| **[Anomaly Detection System](https://github.com/itsSabbir/anomaly-detection-system-2)** | ![Stars](https://img.shields.io/github/stars/itsSabbir/anomaly-detection-system-2?style=flat-square) ![Forks](https://img.shields.io/github/forks/itsSabbir/anomaly-detection-system-2?style=flat-square) | High-throughput system for real-time anomaly detection in genomics data pipelines. Features a containerized microservice architecture and integrates ML models for QC automation. | `Python`, `TensorFlow`, `Scikit-learn`, `FastAPI`, `Docker`, `Kubernetes` |
| **[Image Processing Pipeline](https://github.com/itsSabbir/ImageProcessingPipeline)** | ![Stars](https://img.shields.io/github/stars/itsSabbir/ImageProcessingPipeline?style=flat-square) ![Forks](https://img.shields.io/github/forks/itsSabbir/ImageProcessingPipeline?style=flat-square) | High-performance, multi-threaded C server for concurrent image processing. Engineered for sub-100ms latency with robust synchronization via POSIX threads. | `C`, `Python`, `Linux`, `Sockets`, `TDD` |
| **[Stock Market Prediction](https://github.com/itsSabbir/stockMarketPrediction)** | ![Stars](https://img.shields.io/github/stars/itsSabbir/stockMarketPrediction?style=flat-square) ![Forks](https://img.shields.io/github/forks/itsSabbir/stockMarketPrediction?style=flat-square) | End-to-end forecasting pipeline integrating Kafka for real-time data streaming, sentiment analysis, and ML models (XGBoost, RandomForest) to achieve ~5% prediction accuracy. | `Python`, `Scikit-learn`, `Pandas`, `Kafka`, `Docker`, `Flask` |
| **[Programming Language Hub](https://github.com/itsSabbir/programming-language-learning-hub)** | ![Stars](https://img.shields.io/github/stars/itsSabbir/programming-language-learning-hub?style=flat-square) ![Forks](https://img.shields.io/github/forks/itsSabbir/programming-language-learning-hub?style=flat-square) ![Contributors](https://img.shields.io/github/contributors/itsSabbir/programming-language-learning-hub?style=flat-square) | Open-source educational platform with 100+ examples across 7 languages, serving 1000+ developers. Managed 40+ community contributors. | `React`, `Node.js`, `JavaScript`, `HTML/CSS`, `Git` |
| **[Bioinformatics Pipeline](https://github.com/itsSabbir/bcb-dataprocessing)** | ![Stars](https://img.shields.io/github/stars/itsSabbir/bcb-dataprocessing?style=flat-square) ![Forks](https://img.shields.io/github/forks/itsSabbir/bcb-dataprocessing?style=flat-square) | Reproducible bioinformatics pipeline using Nextflow & Docker/K8s to automate RNA-seq analysis, cutting manual processing time by **40%**. | `R`, `Python`, `Docker`, `Kubernetes`, `Bash`, `Nextflow` |
...
I am a firm believer in perpetual learning to stay at the vanguard of technology. My current deep dives include:
*   **Advanced Cloud Architectures:** Multi-cloud deployments and complex AWS serverless patterns.
*   **Production-Scale MLOps:** Best practices for deploying, monitoring, and managing ML models at scale.
*   **Distributed Systems Design:** Advanced patterns for building highly resilient, fault-tolerant systems.
*   **Systems Programming with Rust:** Exploring Rust for performance-critical backend services and systems tools.
...
`#DataEngineering` `#SoftwareEngineering` `#DataScience` `#Bioinformatics` `#MachineLearning` `#ArtificialIntelligence` `#CloudComputing` `#AWS` `#DevOps` `#SRE` `#FullStack` `#Python` `#Java` `#C++` `#Go` `#Docker` `#Kubernetes` `#OpenSource` `#CancerResearch` `#TechForGood`
