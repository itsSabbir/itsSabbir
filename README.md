...
<p align="center">
  <!-- GitHub Stats Card (Dracula Theme - Includes Private Contributions VIA YOUR DEPLOYMENT) -->
  <img src="https://sabbir-awesome-stats.vercel.app/api?username=itsSabbir&hide_title=false&hide_rank=false&show_icons=true&include_all_commits=true&count_private=true&disable_animations=false&theme=dracula&locale=en&hide_border=false" height="150" alt="Sabbir's GitHub Stats" style="max-width: 100%;"/>

  <!-- GitHub Streak Stats (Dracula Theme - Should include private if GitHub setting is enabled) -->
  ...
  <!-- Top Languages Card (Dracula Theme - Compact Layout - Includes Private Repos VIA YOUR DEPLOYMENT) -->
  <img src="https://sabbir-awesome-stats.vercel.app/api/top-langs?username=itsSabbir&locale=en&hide_title=false&layout=compact&card_width=320&langs_count=8&theme=dracula&hide_border=false&count_private=true" height="150" alt="Sabbir's Top Languages" style="max-width: 100%;"/>
...
My goal is to contribute to innovative teams working on challenging problems in **Software Engineering, DevOps, SRE, Data Engineering, or Data Science**, where I can leverage my diverse skill set and drive impactful results.
...
I enjoy engaging discussions on technology, science, culture, and finding elegant solutions to complex problems (both in and out of code!).
